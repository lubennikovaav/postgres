...
/*
 * colacostestimate. Just copied from blcost.c
 */

PG_FUNCTION_INFO_V1(colacostestimate);
Datum       colacostestimate(PG_FUNCTION_ARGS);
Datum
colacostestimate(PG_FUNCTION_ARGS)
{
